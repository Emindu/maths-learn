...
import { getCh12ConceptById } from '../data/ch12ConceptsData';
import { ConceptContent } from './ProbabilityConceptPage';

export const Ch12ConceptPage: React.FC = () => {
  const { id } = useParams<{ id: string }>();
  const concept = id ? getCh12ConceptById(id) : undefined;
    ...
    return (
      <div style={{
        ...
        <p style={{ color: 'var(--color-text-secondary)', marginBottom: 'var(--space-24)' }}>
          No Chapter 12 concept with id &quot;{id}&quot; exists.
        </p>
        <Link
          to="/#ch12concepts"
          style={{
  ...
  return <ConceptContent concept={concept} backHref="/#ch12concepts" />;
};
