...
import { getCh7ConceptById } from '../data/ch7ConceptsData';
import { ConceptContent } from './ProbabilityConceptPage';

export const Ch7ConceptPage: React.FC = () => {
  const { id } = useParams<{ id: string }>();
  const concept = id ? getCh7ConceptById(id) : undefined;
    ...
    return (
      <div style={{
        ...
        <p style={{ color: 'var(--color-text-secondary)', marginBottom: 'var(--space-24)' }}>
          No Chapter 7 concept with id &quot;{id}&quot; exists.
        </p>
        <Link
          to="/#ch7concepts"
          style={{
  ...
  return <ConceptContent concept={concept} backHref="/#ch7concepts" />;
};
