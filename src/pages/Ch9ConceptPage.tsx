...
import { getCh9ConceptById } from '../data/ch9ConceptsData';
import { ConceptContent } from './ProbabilityConceptPage';

export const Ch9ConceptPage: React.FC = () => {
  const { id } = useParams<{ id: string }>();
  const concept = id ? getCh9ConceptById(id) : undefined;
    ...
    return (
      <div style={{
        ...
        <p style={{ color: 'var(--color-text-secondary)', marginBottom: 'var(--space-24)' }}>
          No Chapter 9 concept with id &quot;{id}&quot; exists.
        </p>
        <Link
          to="/#ch9concepts"
          style={{
  ...
  return <ConceptContent concept={concept} backHref="/#ch9concepts" />;
};
