...
import { getCh10ConceptById } from '../data/ch10ConceptsData';
import { ConceptContent } from './ProbabilityConceptPage';

export const Ch10ConceptPage: React.FC = () => {
  const { id } = useParams<{ id: string }>();
  const concept = id ? getCh10ConceptById(id) : undefined;
    ...
    return (
      <div style={{
        ...
        <p style={{ color: 'var(--color-text-secondary)', marginBottom: 'var(--space-24)' }}>
          No Chapter 10 concept with id &quot;{id}&quot; exists.
        </p>
        <Link
          to="/#ch10concepts"
          style={{
  ...
  return <ConceptContent concept={concept} backHref="/#ch10concepts" />;
};
