...
window.addEventListener('load', () => {
    if (window.MathJax && typeof window.MathJax.typesetPromise === 'function') { (window.MathJax && typeof window.MathJax.typesetPromise === 'function' ? MathJax.typesetPromise() : Promise.resolve()).then(() => {
