...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Render MathJax
  if (window.MathJax && typeof window.MathJax.typesetPromise === 'function') { (window.MathJax && typeof window.MathJax.typesetPromise === 'function' ? MathJax.typesetPromise() : Promise.resolve()); }
});
